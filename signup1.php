...
//$('#first').hide("slow");
$('#first').animate({left:"-40%" },"slow");
$('#second').show('fast');
$('#second').animate({left:"35%",right:"35%"},"fast")
...
//$('#second').hide("slow");
$('#second').animate({left:"-40%"},"slow");
$('#second').hide("slow");
$('#first').animate({left:"35%",right:"35%"},"slow");
...
$('#second').animate({left:"-40%" },"slow");
$('#third').show("fast");
$('#third').animate({left:"35%",right:"35%"},"slow");



});
$("#thirdback").click(function() {
$('#third').animate({left:"-40%" },"slow");
$('#second').show("slow");
$('#second').animate({left:"35%",right:"35%"},"slow");
...
<tr><td  valign="top"><p>Gender</p> </td><td  valign="top"><input type="radio" name="gender" value="male" checked > Male <input type="radio" name="gender" value="female"> Female</td></tr>
